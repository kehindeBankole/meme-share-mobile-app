        ...
        renderItem={() => (
          <View style={{ paddingHorizontal: 15, marginTop: 25 }}>
            ...
            <Stack style={{ marginTop: 15 }}>
              <Text style={styles.memeTitle}>lewis Hamilton meme</Text>
              <Image
                source={require("../assets/meme2.png")}
                style={{
                  width: "auto",
                  height: 200,
                  borderRadius: 7,
              ...
              <Flex direction="row" mt="3">
                <Badge borderRadius="5" style={styles.tags}>
                  <Center>
                    <Text style={styles.tagname}>race</Text>
                  </Center>
                </Badge>
                <Badge borderRadius="5" style={styles.tags}>
                  <Text style={styles.tagname}>f1</Text>
                </Badge>
                <Badge borderRadius="5" style={styles.tags}>
                  <Text style={styles.tagname}>cars</Text>
                </Badge>
              </Flex>
            </Stack>
          </View>
